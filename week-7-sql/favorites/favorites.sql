...
UPDATE shows SET title = "Grey's Anatomy" WHERE title LIKE "greys anatomy";

UPDATE shows SET title = "Grey's Anatomy" WHERE title LIKE "grey's anatomy";

UPDATE shows SET title = "It's Always Sunny in Philadelphia" WHERE title LIKE "its always sunny%";
...
UPDATE shows SET title = "The Bachelorette" WHERE title LIKE "the bachelore%";
